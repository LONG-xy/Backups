<%@ Page Language="C#" AutoEventWireup="true" CodeFile="videoPlaySum.aspx.cs" Inherits="videoPlaySum" MasterPageFile="~/MasterPage.master"%>
    ...
    <div class="movie">
        ...
        <div class="row">
			<div class="col-4-1">
				<div class="wrap-col">
					<div class="post">
                         <asp:DataList ID="dlPlaySum" runat="server" Style="vertical-align: middle">
                            <ItemTemplate>
