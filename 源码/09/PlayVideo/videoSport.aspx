<%@ Page Language="C#" AutoEventWireup="true" CodeFile="videoSport.aspx.cs" Inherits="videoSport" MasterPageFile="~/MasterPage.master"%>
...
<div class="movie">
        ...
        <div class="row">
			<div class="col-4-1">
				<div class="wrap-col">
					<div class="post">
                        <asp:DataList ID="dlSport" runat="server">
                            <ItemTemplate>                            
