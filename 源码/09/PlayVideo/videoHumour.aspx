<%@ Page Language="C#" AutoEventWireup="true" CodeFile="videoHumour.aspx.cs" Inherits="videoHumour" MasterPageFile="~/MasterPage.master"%>
...
<div class="movie">
        ...
        <div class="row">
			<div class="col-4-1">
				<div class="wrap-col">
					<div class="post">
                        <asp:DataList ID="dlHumour" runat="server">
                            <ItemTemplate>                            
