<%@ Page Language="C#" AutoEventWireup="true" CodeFile="videoNew.aspx.cs" Inherits="videoNew" MasterPageFile="~/MasterPage.master" %>
    ...
    <div class="movie">
        ...
        <div class="row">
			<div class="col-4-1">
				<div class="wrap-col">
					<div class="post">
                         <asp:DataList ID="dlNewVideo" runat="server">
                            <ItemTemplate>
