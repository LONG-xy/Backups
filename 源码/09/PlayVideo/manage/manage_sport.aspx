<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/manage/MasterPage.master" CodeFile="manage_sport.aspx.cs" Inherits="manage_manage_sport" %>
    ...
    <div class="widget widget-table">										
		...
		<div class="widget-content">
            ...
            <asp:GridView ID="gvVideo" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvVideo_RowDataBound" OnRowDeleting="gvVideo_RowDeleting" 
                OnSelectedIndexChanging="gvVideo_SelectedIndexChanging" AllowPaging="True" OnPageIndexChanging="gvVideo_PageIndexChanging" Width="95%" CssClass="grid" CellPadding="4" ForeColor="#333333" GridLines="None" HorizontalAlign="Center">
