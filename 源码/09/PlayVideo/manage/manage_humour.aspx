<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/manage/MasterPage.master" CodeFile="manage_humour.aspx.cs" Inherits="manage_manage_humour" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="BodyHoder" runat="server">
    ...
    <div class="widget widget-table">										
		...
		<div class="widget-content">
            ...
            <asp:GridView ID="gvVideo" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvVideo_RowDataBound" OnRowDeleting="gvVideo_RowDeleting"  CssClass="grid"
                OnSelectedIndexChanging="gvVideo_SelectedIndexChanging" AllowPaging="True" OnPageIndexChanging="gvVideo_PageIndexChanging" Width="95%" HorizontalAlign="Center" CellPadding="4" ForeColor="#333333" GridLines="None">
                ...
                <RowStyle Height="30px" HorizontalAlign="Center" BackColor="#F7F6F3" ForeColor="#333333" />                       
                <EditRowStyle BackColor="#999999" />
                <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                <HeaderStyle BackColor="#5D7B9D" Height="40px" HorizontalAlign="Center" Font-Bold="True" ForeColor="White" />
