<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manage_cartoon.aspx.cs" MasterPageFile="~/manage/MasterPage.master" Inherits="manage_manage_cartoon" %>
    ...
    <div class="widget widget-table">										
		...
		<div class="widget-content">
            ...
            <asp:GridView ID="gvVideo" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvVideo_RowDataBound" OnRowDeleting="gvVideo_RowDeleting" 
                OnSelectedIndexChanging="gvVideo_SelectedIndexChanging" AllowPaging="True" OnPageIndexChanging="gvVideo_PageIndexChanging" CssClass="grid" CellPadding="4" ForeColor="#333333" GridLines="None" HorizontalAlign="Center" Width="95%">
