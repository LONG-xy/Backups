<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ASPProduct.ascx.cs" Inherits="Common_ASPProduct" %>
<table width="247" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="186" height="21" background="../images/fenlei1.gif"><table width="186" height="19" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="16">&nbsp;</td>
                            <td width="108" class="wenzi3">ASP+PHP </td>
                            <td width="62">&nbsp;</td>
                          </tr>
                      </table></td>
                      <td width="46"><img src="../images/fenlei2.gif" width="46" height="21" border="0" usemap="#Map6MapMap"></td>
                    </tr>
                    <tr>
                      <td width="15">&nbsp;</td>
                    ...
                    <tr>
                      ...
                      <td colspan="2" valign="top" rowspan="3"><asp:DataList ID="dlASPPro" runat="server" RepeatColumns="2" RepeatDirection="Horizontal" Width="229px">
                <ItemTemplate>
                    <table>
                        <tr>
                            <td style="text-align: center">
                                <a title="<%# Eval("Name")%>" href="../User/Sort.aspx?ASPID=<%# DataBinder.Eval(Container.DataItem,"ID") %>"
                  ...
                  <map name="Map6MapMap">
                    <area shape="rect" coords="0,3,43,18" href="../User/Sort.aspx?PID=2">
                  </map>