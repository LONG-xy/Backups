                                ...
                                <tr>
                                    <td>
                                        ...
                                        <span class="chengse">联系人：<%#DataBinder.Eval(Container.DataItem,"linkMan") %>
                                            联系电话：<%#DataBinder.Eval(Container.DataItem,"tel") %></span></p></td>
                                </tr>
                                    ...
                                    <table align="center" cellpadding="0" cellspacing="0" width="543">
                                        <tr>
                                            <td class="huise">
                                                ...
                                                <p class="custom-content-p">
                                                    <span class="banhui">
                                                    <%# DataBinder.Eval(Container.DataItem,"info") %></span>
                                                </p>
                                                
                                                <p class="custom-content-p">
                                                <span class="banhui">联系人：<%#DataBinder.Eval(Container.DataItem,"linkMan") %>
                                                    联系电话：<%#DataBinder.Eval(Container.DataItem,"tel") %></span>
                                                </p>
                                                </td>
                                        </tr>
                                        <tr style="color: #000000">
