...
function playVideo(a) {
    if (a && a.bgAudio) {
        ...
        c.bind("canplay", function() {
            ...
            d.addClass("play_yinfu").removeClass("off"),
            e.addClass("rotate")
        }).bind("pause", function() {
            d.addClass("off").removeClass("play_yinfu"),
...
function(a) {
    ...
    var f = a.templateParser("jsonParser", function() {
        ...
        function b(a, b) {
            ...
            if (c) {
                ...
                "L" == ("" + a.type).charAt(0) && e.addClass("wsite-button"),
    ...
    f.addComponent("3", function(a) {
        ...
        "edit" == f.mode ? (b = $("#nr .edit_wrapper"),
        c.setAttribute("class", "wrapper-background")) : "view" == f.mode && (b = $("#edit_area" + f.def.id).parent(".edit_wrapper"),
        c.setAttribute("id", "wrapper-background" + f.def.id)),
        $(c).prependTo(b).css({
            width: "100%",
            height: "100%"
        });
    ...
    f.addComponent("8", function(a) {
        ...
        return a.properties.imgSrc ? (c = $('<img style="width: 100%; height: 100%;" src="' + (PREFIX_FILE_HOST + a.properties.imgSrc) + '"></img>'),
        $(b).html(c),
        "view" == f.mode && $(b).attr("href", "tel:" + a.properties.number)) : a.properties.title && (c = a.properties.title.replace(/ /g, "&nbsp;"),
        $(b).html(c),
        "view" == f.mode && $(b).attr("href", "tel:" + a.properties.number)),
        b.style.cursor = "default",
        b.style.width = "100%",
        b
    }),
    ...
    f.addComponent("i", function(b) {
        ...
        if (d.append(e),
        "view" == f.mode ? a.counterValues && a.counterValues.then(function(a) {
            var c = a.map[b.id] || 0;
            e.text(c)
        ...
        "counter-tb" === b.properties.layout) {
            var g = 0;
            g = b.properties.imgSrc ? "counter-l" == b.properties.size ? 77 : "counter-m" == b.properties.size ? 71 : 66 : "counter-l" == b.properties.size ? 40 : "counter-m" == b.properties.size ? 30 : 20,
            d.css("margin-top", -g)
        }
        return c.append(d),
    ...
    f.bindAfterRenderEvent("L", function(a, b) {
        "view" == f.mode && $(a).click(function() {
            var html = '<ul class="myform" id="ccform' + b.id + '"> <li comp-drag="" comp-rotate="" class="comp-resize comp-rotate inside wsite-input" id="inside_788" num="1" ctype="501" comp-resize="" style="width: 96px; height: 30px; left: 5px; top: 0px; z-index: 1;"><div class="element-box" style="top: 2px; left: 5px; z-index: 1; color: rgb(103, 103, 103); border: 1px solid rgb(204, 204, 204); width: 100%; height: 100%; transform: none; background-color: rgb(249, 249, 249);"><div class="element-box-contents" style="width: 100%; height: 100%;"><textarea id="788" ctype="501" class="element comp_input editable-text" required="required" placeholder="姓名" name="eq[f_788]" style="width: 96px; height: 31px;"></textarea></div></div></li>' + 
            '<li comp-drag="" comp-rotate="" class="comp-resize comp-rotate inside wsite-input" id="inside_1111" num="1" ctype="502" comp-resize="" style="width: 130px; height: 31px; left: 100px; top: 0px; z-index: 4;position: absolute;"><div class="element-box" style="top: 2px; left: 105px; z-index: 4; color: rgb(103, 103, 103); border: 1px solid rgb(204, 204, 204); background-color: rgb(249, 249, 249); width: 100%; height: 100%; -webkit-transform: none;"><div class="element-box-contents" style="width: 100%; height: 100%;"><textarea id="1111" ctype="502" class="element comp_input editable-text" placeholder="出席人数" name="eq[f_1111]" style="width: 130px; height: 32px;"></textarea></div></div></li>' + 
            '<li comp-drag="" comp-rotate="" class="comp-resize comp-rotate inside wsite-input" id="inside_140" num="1" ctype="5" comp-resize="" style="width: 230px; height: 50px; left: 4px; top: 37px; z-index: 2;margin-top: 2px;"><div class="element-box" style="top: 37px; left: 4px; z-index: 2; color: rgb(103, 103, 103); border: 1px solid rgb(204, 204, 204); width: 100%; height: 100%; transform: none; background-color: rgb(249, 249, 249);"><div class="element-box-contents" style="width: 100%; height: 100%;"><textarea id="140" ctype="5" class="element comp_input editable-text" required="required" placeholder="请输入祝福话语" name="eq[f_140]" style="width: 222px; height: 55px;"></textarea></div></div></li>' + 
            '<li comp-drag="" comp-rotate="" class="comp-resize comp-rotate inside wsite-button" id="inside_268" num="1" ctype="6" comp-resize="" style="width: 78px; height: 81px; left: 238px; top: 1px; z-index: 3;position: absolute;"><div class="element-box" style="top: 1px; left: 238px; z-index: 3;   border: 1px solid rgb(204, 204, 204); width: 100%; height: 100%; transform: none; /* background-color: rgb(249, 249, 249); */"><div class="element-box-contents" style="width: 100%; height: 100%;"><button id="mysubmit' + b.id + '" ctype="6" class="element comp_button editable-text" style="width: 78px; height: 91px;">提交</button></div></div></li></ul>' + 
            '<div id="mymessages' + b.id + '" class="mymessages' + b.id + '"></div>';
            $(a).hide(),
            ...
            getLyList(b.id, b.sceneId, b.pageId),
    ...
    f.bindAfterRenderEvent("s", function(a, b) {
        a = $("a", a)[0],
        "view" == f.mode && $(a).click(function(a) {})
    }),
    f.bindAfterRenderEvent("i", function(a, b) {
        if ("view" == f.mode) {
    ...
    f.bindAfterRenderEvent("n", function(a, b) {}),
    f.bindAfterRenderEvent("h", function(a, b) {
        "view" == f.mode && b.properties.url && $(a).click(function(a) {
            var c = b.properties.url;
            isNaN(c) ? window.open(c) : eqxiu.pageScroll(c)
        })
    ...
    f.bindAfterRenderEvent("5", function(a, b) {
        var d = mobilecheck();
        c($(a).find("textarea")),
        "view" == f.mode && d && parseFloat(b.css.top) >= 280 && ($(a).find("textarea").focus(function(b) {
    ...
    f.bindAfterRenderEvent("m", function(a, c) {
        "view" == f.mode && $(a).click(function() {
            $(a).hide(),
            $("#map_btn").hasClass("map_exist") && $("#map_btn").hide(),
            $('<div class="map_mask" id="mask_' + c.id + '"></div>').appendTo($(a).closest(".m-img")),
            ...
            $("#close_" + c.id).bind("click", function() {
                $(a).show(),
                $("#mask_" + c.id).remove(),
                $("#close_" + c.id).remove(),
            ...
            var c = function(b, c) {
                ...
                d) {
                    ...
                    return g ? void $.ajax({
                        cache: !0,
                        type: "POST",
                        url: PREFIX_URL + "index.php?c=scenedata&a=add&id=" + c,
                        data: $.param(f),
                        async: !1,
                        error: function(a) {
                            alert("Connection error")
...
var eqxiu = function() {
    function a(a) {
        if ("10" != e._scrollMode) {
            ...
            d || (d = a);
            var h = $(e.$currentPage).find(".m-img").attr("id").substring(4)
              , 
    ...
    function b() {
        if ("10" != e._scrollMode) {
            ...
            var b = setInterval(function() {
                a += 2,
                "0" == e._scrollMode || "1" == e._scrollMode || "2" == e._scrollMode || "6" == e._scrollMode || "7" == e._scrollMode || "8" == e._scrollMode || "11" == e._scrollMode || "12" == e._scrollMode ? u = a : ("3" == e._scrollMode || "4" == e._scrollMode || "5" == e._scrollMode || "9" == e._scrollMode) && (t = a),
                g(),
    ...
    function c() {
        if ("10" != e._scrollMode) {
            ...
            var b = setInterval(function() {
                ...
                h(),
                o || e.$activePage || clearInterval(m))
            }, 1)
        } else
            turnBookNextPage()
    }
    ...
    var e, f, g, h, i, j, k, l, m, n = $(window), 
    o = !1, 
    p = !1, 
    q = mobilecheck(), 
    r = 0, 
    ...
    A = function(a, b, c, k) {
        ...
        function B() {
            ...
            var a;
            "0" == b || "1" == b || "2" == b || "6" == b || "9" == b || "11" == b || "12" == b ? (a = u > 0 ? -j : j,
            A($(e.$activePage), "transform", "translateY(" + a + "px)"),
            A($(e.$currentPage), "transform", "translateY(0) scale(1)")) : ("3" == b || "5" == b) && (a = t > 0 ? -i : i,
            A($(e.$activePage), "transform", "translateX(" + a + "px)"),
            A($(e.$currentPage), "transform", "translateX(0) scale(1)")),
            setTimeout(function() {
                $(e.$currentPage).attr("style", ""),
                $(e.$activePage).attr("style", ""),
                $(e.$activePage).removeClass("z-active z-move"),
        ...
        function C() {
            if (Math.abs(u) > Math.abs(t) && completeEffect($(e.$currentPage)))
                if (u > 0) {
                    ...
                    x = !1,
                    U(!0),
                    V(!0, "bottom center", "translateY", j)) : W(!0, "translateY", j, u, e._scrollMode)
                } else if (0 > u) {
                    ...
                    x = !1,
                    U(!1),
                    V(!1, "top center", "translateY", j)) : W(!1, "translateY", j, u, e._scrollMode)
                }
        }
        function D() {
            Math.abs(u) > Math.abs(t) && Math.abs(u) > 20 ? (X("translateY", u, j, e._scrollMode),
            $(document).trigger("flipend")) : (e._isDisableFlipPage = !1,
            B())
        }
        function E() {
            if (Math.abs(t) > Math.abs(u) && completeEffect($(e.$currentPage)))
                if (t > 0) {
                    ...
                    x = !1,
                    U(!0),
                    V(!0, "center right", "translateX", i)) : W(!0, "translateX", i, t, e._scrollMode)
                } else if (0 > t) {
                    if (e._isDisableFlipNextPage)
                        return;
                    !w || x ? (w = !0,
                    x = !1,
                    U(!1),
                    V(!1, "center left", "translateX", i)) : W(!1, "translateX", i, t, e._scrollMode)
                }
        }
        function F() {
            Math.abs(t) > Math.abs(u) && Math.abs(t) > 20 ? (X("translateX", t, i, e._scrollMode),
            $(document).trigger("flipend")) : (e._isDisableFlipPage = !1,
            B())
        }
        function G() {
            if (Math.abs(t) > Math.abs(u) && completeEffect($(e.$currentPage)))
                if (t > 0) {
                    ...
                    x = !1,
                    U(!0),
                    i = q ? window.innerWidth : $(".nr").width(),
                    V(!0, "", "translateX", i)) : W(!0, "translateX", i, t, e._scrollMode)
                } else if (0 > t) {
                    if (e._isDisableFlipNextPage)
                        return;
                    !w || x ? (w = !0,
                    ...
                    U(!1),
                    i = q ? window.innerWidth : $(".nr").width(),
                    V(!1, "", "translateX", i)) : W(!1, "translateX", i, t, e._scrollMode)
                }
        }
        function H() {
            Math.abs(t) > Math.abs(u) && Math.abs(t) > 20 ? (X("translateX", t, i, e._scrollMode),
        ...
        function I() {
            if (Math.abs(u) > Math.abs(t) && completeEffect($(e.$currentPage)))
                if (u > 0) {
                    ...
                    x = !1,
                    U(!0),
                    j = q ? window.innerHeight : $(".nr").height(),
                    V(!0, "", "translateY", j)) : W(!0, "translateY", j, u, e._scrollMode)
                } else if (0 > u) {
                    if (e._isDisableFlipNextPage)
                        return;
                    !w || x ? (w = !0,
                    ...
                    U(!1),
                    j = q ? window.innerHeight : $(".nr").height(),
                    V(!1, "", "translateY", j)) : W(!1, "translateY", j, u, e._scrollMode)
                }
        }
        function J() {
            Math.abs(u) > Math.abs(t) && Math.abs(u) > 20 ? (X("translateY", u, j, e._scrollMode),
        ...
        function K() {
            if (Math.abs(u) > Math.abs(t) && completeEffect($(e.$currentPage)))
                if (u > 0) {
                    ...
                    (!w || x) && (w = !0,
                    x = !1,
                    e.$activePage && $(e.$activePage).removeClass("z-move z-active"),
                    U(!0),
                    m(e.$activePage.style, "Transform", "rotateX(90deg) translateY(-" + j / 2 + "px) translateZ(" + j / 2 + "px)"),
                    m(Y.get(0).style, "Perspective", "700px"),
                    m(Y.get(0).style, "TransformStyle", "preserve-3d")),
                    e.$activePage && e.$activePage.classList.contains("main-page") && ($(e.$activePage).addClass("z-active z-move").trigger("active").css("zIndex", 1),
                    m(e.$currentPage.style, "Transform", "rotateX(-" + u / j * 90 + "deg) translateY(" + u / 2 + "px) translateZ(" + u / 2 + "px)"),
                    m(e.$activePage.style, "Transform", "rotateX(" + (90 - u / j * 90) + "deg) translateY(" + (-(j / 2) + u / 2) + "px) translateZ(" + (j / 2 - u / 2) + "px)"))
                } else if (0 > u) {
                    if (e._isDisableFlipNextPage)
                        return;
                    (!w || x) && (w = !0,
                    ...
                    m(Y.get(0).style, "Perspective", "700px"),
                    m(Y.get(0).style, "TransformStyle", "preserve-3d")),
                    e.$activePage && e.$activePage.classList.contains("main-page") ? ($(e.$activePage).addClass("z-active z-move").trigger("active").css("zIndex", 0),
                    m(e.$currentPage.style, "Transform", "rotateX(" + -u / j * 90 + "deg) translateY(" + u / 2 + "px) translateZ(" + -u / 2 + "px)"),
                    m(e.$activePage.style, "Transform", "rotateX(" + (-90 - u / j * 90) + "deg) translateY(" + (j / 2 + u / 2) + "px) translateZ(" + (j / 2 + u / 2) + "px)")) : (m(e.$currentPage.style, "Transform", "translateX(0px) scale(1)"),
                    e.$activePage = null )
                }
        }
        function L() {
            Math.abs(u) > Math.abs(t) && Math.abs(u) > 20 ? (u > 0 ? m(e.$currentPage.style, "Transform", "rotateX(-90deg) translateY(" + j / 2 + "px) translateZ(" + j / 2 + "px)") : m(e.$currentPage.style, "Transform", "rotateX(90deg) translateY(-" + j / 2 + "px) translateZ(" + j / 2 + "px)"),
            m(e.$currentPage.style, "zIndex", "0"),
            m(e.$activePage.style, "Transform", "rotateX(0deg) translateY(0px) translateZ(0px)"),
            m(e.$activePage.style, "zIndex", "2"),
            $(document).trigger("flipend")) : (m(e.$currentPage.style, "Transition", "none"),
            m(e.$activePage.style, "Transition", "none"),
            e._isDisableFlipPage = !1,
            B())
        }
        function M() {
            if (Math.abs(u) > Math.abs(t) && completeEffect($(e.$currentPage)))
                if (u > 0) {
                    ...
                    m(Y.get(0).style, "Perspective", "700px"),
                    m(Y.get(0).style, "TransformStyle", "preserve-3d"),
                    m(e.$activePage.style, "TransformOrigin", "top"),
                    m(e.$activePage.style, "Transform", "rotateX(90deg)")),
                    e.$activePage && e.$activePage.classList.contains("main-page") && ($(e.$activePage).addClass("z-active z-move").trigger("active"),
                    m(e.$activePage.style, "Transform", "rotateX(" + (90 - u / j * 90) + "deg) "))
                } else if (0 > u) {
                    if (e._isDisableFlipNextPage)
                        return;
                    (!w || x) && (w = !0,
                    ...
                    e.$activePage && $(e.$activePage).removeClass("z-move z-active"),
                    U(!1),
                    m(e.$activePage.style, "TransformOrigin", "bottom"),
                    m(e.$activePage.style, "Transform", "rotateX(-90deg)"),
                    m(Y.get(0).style, "Perspective", "700px"),
                    m(Y.get(0).style, "TransformStyle", "preserve-3d")),
                    e.$activePage && e.$activePage.classList.contains("main-page") ? ($(e.$activePage).addClass("z-active z-move").trigger("active"),
                    m(e.$activePage.style, "Transform", "rotateX(" + (-90 - u / j * 90) + "deg) ")) : (m(e.$currentPage.style, "Transform", "translateX(0px) scale(1)"),
                    e.$activePage = null )
                }
        }
        function N() {
            Math.abs(u) > Math.abs(t) && Math.abs(u) > 20 ? (u > 0 ? m(e.$activePage.style, "Transform", "rotateX(0deg)") : m(e.$activePage.style, "Transform", "rotateX(0deg)"),
            $(document).trigger("flipend")) : (m(e.$currentPage.style, "Transition", "none"),
            m(e.$activePage.style, "Transition", "none"),
            e._isDisableFlipPage = !1,
            B())
        ...
        function O() {
            if (Math.abs(u) > Math.abs(t) && completeEffect($(e.$currentPage))) {
                if (u > 0) {
                    ...
                    (w || x) && (w = !1,
                    x = !1,
                    e.$activePage && (e.$activePage.classList.remove("z-active"),
                    e.$activePage.classList.remove("z-move")),
                    U(!0),
                    e.$activePage.style.zIndex = 2,
                    e.$activePage && e.$activePage.classList.contains("main-page") && (e.$activePage.classList.add("z-active"),
                    e.$activePage.classList.add("z-move")),
                    e.$activePage.style.opacity = 0)
                } else if (0 > u) {
                    if (e._isDisableFlipNextPage)
                        return;
                    (!w || x) && (w = !0,
        ...
        function P() {
            Math.abs(u) > Math.abs(t) && Math.abs(u) > 20 ? (A($(e.$activePage), "transform", "scale(1)"),
            e.$activePage.style.opacity = 1,
            $(document).trigger("flipend")) : (m(e.$currentPage.style, "Transition", "none"),
            m(e.$activePage.style, "Transition", "none"),
            e._isDisableFlipPage = !1,
            B())
        ...
        function Q() {
            if (Math.abs(t) > Math.abs(u) && completeEffect($(e.$currentPage)))
                if (t > 0) {
                    ...
                    e.$activePage && e.$activePage.classList.contains("main-page") && (e.$activePage.classList.add("z-active"),
                    e.$activePage.classList.add("z-move"),
                    A($(e.$activePage), "Transform", "scale(0.3) translateX(0) translateZ(-" + j + "px) rotateY(45deg)"),
                    e.$activePage.style.zIndex = "0"),
                    m(Y.get(0).style, "Perspective", "1000px"),
                    e.$currentPage.style.zIndex = "100") : e.$activePage && (i / 4 >= t ? A($(e.$currentPage), "Transform", "translateX(" + t + "px)") : A($(e.$currentPage), "Transform", "translateX(" + 1.5 * t + "px) scale(" + ((5 * i / 4 - t) / i).toFixed(3) + ") rotateY(" + t / i * 45 + "deg) translateZ(-" + (t - i / 4) + "px)"))
                } else if (0 > t) {
                    if (e._isDisableFlipNextPage)
                        return;
                    !w || x ? (w = !0,
                    ...
                    e.$activePage && e.$activePage.classList.contains("main-page") && (e.$activePage.classList.add("z-active"),
                    e.$activePage.classList.add("z-move"),
                    A($(e.$activePage), "Transform", "scale(0.3) translateX(" + (i + 300) + "px) translateZ(-" + j + "px) rotateY(-45deg)"),
                    e.$activePage.style.zIndex = "0"),
                    m(Y.get(0).style, "Perspective", "1000px"),
                    e.$currentPage.style.zIndex = "100") : e.$activePage && (t >= -i / 4 ? A($(e.$currentPage), "Transform", "translateX(" + t + "px)") : A($(e.$currentPage), "Transform", "translateX(" + 1.5 * t + "px) scale(" + ((5 * i / 4 + t) / i).toFixed(3) + ") rotateY(" + t / i * 45 + "deg) translateZ(" + (t + i / 4) + "px)"),
                    A($(e.$activePage), "Transform", "scale(" + (.3 - (t + i / 4) / i).toFixed(3) + ") translateX(" + (-t - i / 4 + 200) + "px) translateZ(" + (-t - 3 * i / 4) + "px) rotateY(-" + (45 + (t + i / 4) / i * 45) + "deg)"))
                }
        }
        function R() {
            Math.abs(t) > Math.abs(u) && Math.abs(t) > 20 ? (t > 0 ? (e.$currentPage.style.webkitTransformOrigin = "left",
            e.$currentPage.style.webkitTransform = "translateX(0) translateZ(-" + j + "px) rotateY(0) scale(0.2)",
            e.$activePage.style.webkitTransform = "translateX(0) translateZ(0) rotateY(0) scale(1)",
            e.$currentPage.style.zIndex = "0",
            e.$activePage.style.zIndex = "1") : (e.$currentPage.style.webkitTransformOrigin = "right",
            e.$currentPage.style.webkitTransform = "translateX(" + i + "px) translateZ(-" + j + "px) rotateY(0) scale(0.2)",
            e.$activePage.style.webkitTransform = "translateX(0) translateZ(0) rotateY(0) scale(1)",
            e.$activePage.style.zIndex = "1",
            e.$currentPage.style.zIndex = "0"),
            $(document).trigger("flipend")) : (m(e.$currentPage.style, "Transition", "none"),
            m(e.$activePage.style, "Transition", "none"),
            e._isDisableFlipPage = !1,
        ...
        function S() {
            if (Math.abs(u) > Math.abs(t) && completeEffect($(e.$currentPage))) {
                if (u > 0) {
                    ...
                    e.$activePage.classList.remove("z-move")),
                    U(!0),
                    e.$activePage && e.$activePage.classList.contains("main-page") && ($(e.$activePage).addClass("z-active z-move"),
                    $(e.$activePage).css({
                        zIndex: 0,
                        opacity: 1
                    })),
                    ...
                    A($(e.$activePage), "transform", "translateY(0)"),
                    A($(e.$currentPage), "transform-origin", "0% 0% 0px"))
                } else if (0 > u) {
                    if (e._isDisableFlipNextPage)
                        return;
                    (!w || x) && (w = !0,
                ...
                e.$activePage && (A($(e.$currentPage), "transform-origin", "0% 0% 0px"),
                A($(e.$currentPage), "transform", "rotate(" + Math.abs(u) / j * 90 + "deg)"),
                e.$currentPage.style.opacity = ((j - Math.abs(u)) / j).toFixed(1))
            }
        }
        function T() {
            Math.abs(u) > Math.abs(t) && Math.abs(u) > 20 ? (A($(e.$currentPage), "transform", "translateY(" + j + "px) rotate(" + Math.abs(u) / j * 90 + "deg)"),
            $(e.$currentPage).css({
                opacity: .5
            }),
            $(document).trigger("flipend")) : (m(e.$currentPage.style, "Transition", "none"),
        ...
        function V(a, b, c, d) {
            if (e.$activePage && (e.$activePage.classList.remove("z-active"),
            e.$activePage.classList.remove("z-move")),
            e.$activePage && e.$activePage.classList.contains("main-page")) {
        ...
        b = b,
        e = this,
        i = q ? window.innerWidth : a.width(),
        j = q ? window.innerHeight : a.height();
        var Y = $("#con")
          , 
        Z = !1;
        ("8" == b || "9" == b) && (z = .7,
        y = 800),
        k.obj.property.hasOwnProperty("triggerLoop") || (k.obj.property.triggerLoop = !0),
        o = k.obj.property.triggerLoop,
        k.obj.property.autoFlip && (l = 1e3 * k.obj.property.autoFlipTime,
        d());
        ...
        f = function(a) {
            Z = !1,
            q && a && (a = event),
            e._isDisableFlipPage || (e.$currentPage = e._$pages.filter(".z-current").get(0),
            p || (e.$activePage = null ),
            e.$currentPage && completeEffect($(e.$currentPage)) && (v = !0,
            w = !1,
            x = !0,
            t = 0,
            u = 0,
            a && "mousedown" == a.type ? (r = a.pageX,
            s = a.pageY) : a && "touchstart" == a.type && (r = a.touches[0].pageX,
            s = a.touches[0].pageY),
            e.$currentPage.classList.add("z-move"),
            m(e.$currentPage.style, "Transition", "none"),
            "12" == b && (e.$currentPage.style.zIndex = 3)))
        }
        ,
        g = function(a) {
            if (q && a && (a = event),
            v && e._$pages.length > 1) {
                if (a && "mousemove" == a.type ? (t = a.pageX - r,
                u = a.pageY - s) : a && "touchmove" == a.type && (t = a.touches[0].pageX - r,
                u = a.touches[0].pageY - s),
                !Z && (Math.abs(t) > 20 || Math.abs(u) > 20)) {
                    if (e.$activePage) {
                        ...
                        $(e.$activePage).find("li").each(function(a) {
                            for (var b = 0; b < e._pageData[d - 1].elements.length; b++)
                                e._pageData[d - 1].elements[b].id == parseInt($(this).attr("id").substring(7), 10) && (eqxCommon.animation($(this), c[d - 1].elements[b], "view"),
        ...
        h = function(a) {
            if (v && completeEffect($(e.$currentPage)))
                ...
                e.$activePage) {
                    ...
                    e.$currentPage.style.webkitTransition = "-webkit-transform " + z + "s " + c,
                    e.$activePage.style.webkitTransition = "-webkit-transform " + z + "s " + c,
                    e.$currentPage.style.mozTransition = "-moz-transform " + z + "s " + c,
                    e.$activePage.style.mozTransition = "-moz-transform " + z + "s " + c,
                    e.$currentPage.style.transition = "transform " + z + "s " + c,
                    e.$activePage.style.transition = "transform " + z + "s " + c,
        ...
        $(document).on("flipend", function(a) {
            ...
            setTimeout(function() {
                ...
                utilSound.pause(),
                c.length && c.remove(),
                ("8" == b || "9" == b || "12" == b) && ($(e.$currentPage).css("z-index", "1"),
...
function(a, b) {
    function c(a, c) {
        if (!b("#report0").length) {
            ...
            e[2] = '<div id="report2"><p><img src="/assets/images/jubao_03.png" width="50px;"></p><h1>请选择举报原因</h1></div>',
...
function(a, b) {
    function c(a, c) {
        a.obj.property.activityPageId && (r = b.ajax({
            type: "GET",
            url: PREFIX_URL + "?c=scene&a=getlastpagebg&id=" + a.obj.property.activityPageId,
            xhrFields: {
                withCredentials: !0
            },
            crossDomain: !0,
    ...
    function d(a, c, d) {
        ...
        g = '{"id":81395,"pageId":"","sceneId":"","num":1,"type":"4","isInput":0,"title":null,"content":null,"status":1,"css":{"borderRadius":"%","borderStyle":"solid","height":"136","zIndex":"1000","paddingTop":"0px","borderColor":"rgba(0,0,0,1)","boxShadow":"0 0px 0px #333333","color":"#000000","backgroundColor":"rgba(0,0,0,0)","borderWidth":"0px","width":"143","left":"93px","paddingBottom":"0px","top":"182px"},"properties":{"height":"100px","imgStyle":{"width":139,"height":136,"marginTop":"0px","marginLeft":"0px"},"width":"100px","src":"group1/M00/01/30/yq0JCFQpOR-AOULFAAFBPO1yzBQ984.jpg"}}'
          , 
        j = '{"id":81465,"pageId":"","sceneId":"","num":1,"type":"2","isInput":0,"title":null,"content":"<div style=\\"text-align: center;\\"><font color=\\"#ffffff\\" size=\\"3\\">击此处进行编辑</font></div>","status":1,"css":{"zIndex":"102","height":"65","width":"320","left":"0px","top":"70px"},"properties":{}}';
        if (n = 1,
        a.obj.property.lastPageId)
            o = !0,
            b.ajax({
                type: "GET",
                url: PREFIX_URL + "?c=scene&a=getlastpagebg&id=" + a.obj.property.lastPageId,
                xhrFields: {
                    withCredentials: !0
                },
                crossDomain: !0,
                success: function(b) {
                    if (!b.obj) {
                        f = f.replace(/id=16060/, "id=" + a.obj.id);
                        var d = JSON.parse(f);
                        ...
                        d.elements[1].properties.height = 65,
                        d.elements[1].height = 65,
                        void e(d, c, a)
                    }
                    b.obj.sceneId = a.obj.id;
                    var h = JSON.parse(g);
                    h.properties.src = a.obj.cover,
                    ...
                    for (var l = 0; l < b.obj.elements.length; l++)
                        "2" == b.obj.elements[l].type && /http:\/\/service.eqxiu.com\/eqs\/link/.test(b.obj.elements[l].content) && (console.log(b.obj.elements[l].content),
                        b.obj.elements[l].content = b.obj.elements[l].content.replace(/;url=.*com"/, ";url=" + encodeURIComponent(i) + '"'));
                    e(b.obj, c, a)
                }
            });
        else {
            f = f.replace(/id=16060/, "id=" + a.obj.id);
            var k = JSON.parse(f);
            k.num = a.list.length + 1,
            k.elements[2].properties.src = a.obj.cover,
            k.elements[1].content = k.elements[1].content.replace(/场景名称/, a.obj.name),
            e(k, c, a)
        }
    }
    function e(a, b) {
        var c = '{"id":480292,"pageId":136042,"sceneId":16060,"num":1,"type":"2","isInput":0,"title":null,"content":"<div style=\\"text-align: center;transform: none;-webkit-animation: fadeIn 2s ease 1s both;-webkit-animation-play-state: initial;\\"><a href=\\"' + PREFIX_S1_URL + "?c=scene&a=link&id=16060&amp;url=" + encodeURIComponent(i) + '\\" target=\\"_blank\\" style=\\"font-size: x-small;display:block;line-height: 10px;\\"><font color=\\"#ffffff\\">' + j + '</font></a></div>","status":1,"css":{"zIndex":"1000","height":"20","width":"129","left":"97px","top":"418px","backgroundColor":"rgba(0,0,0,0.6)","borderRadius":"20px"},"properties":{"anim":{"type":0,"direction":0,"duration":2,"delay":"0"}}}';
        n = 2;
    ...
    function f(a, c) {
        ...
        b.ajax({
            type: "GET",
            url: PREFIX_URL + "?c=scene&a=getlastpagebg&id=" + a.obj.property.bottomLabel.id,
            xhrFields: {
                withCredentials: !0
            },
            crossDomain: !0,
            success: function(d) {
                if (!d.obj)
                    return void e(a, c);
                var f = d.obj.elements
                  , 
                g = 0;
                for (f.length; g < f.length; g++) {
                    var i = f[g];
                    if (i.sceneId = a.obj.id,
                    i.pageId = c[c.length - 1].id,
                    a.obj.property.bottomLabel.name && a.obj.property.bottomLabel.url && "http://" != a.obj.property.bottomLabel.url)
                        2 == i.type && i.content.indexOf("微上宝科技公司") > 0 && (i.content = i.content.replace(/微上宝科技公司/, '<a href="' + PREFIX_S1_URL + "?c=scene&a=link&id=" + a.obj.id + "&amp;url=" + encodeURIComponent(a.obj.property.bottomLabel.url) + '" target=_blank>' + a.obj.property.bottomLabel.name + "</a>"));
                    else if (a.obj.property.bottomLabel.name)
                        2 == i.type && i.content.indexOf("微上宝科技公司") > 0 && (i.content = i.content.replace(/微上宝科技公司/, a.obj.property.bottomLabel.name));
                    else if (/技术支持/.test(i.content)) {
    ...
    function h(c, d) {
        for (var e = [], f = !1, g = {
            ...
            if (b('<section class="main-page"><div class="m-img" id="page' + h + '"></div></section>').appendTo(".nr"),
            10 == k && (b("#page" + h).parent(".main-page").wrap('<div class="flip-mask" id="flip' + h + '"></div>'),
            b(".main-page").css({
                width: b(".nr").width() + "px",
                height: b(".nr").height() + "px"
            })),
            c.length > 1 && (0 == k || 1 == k || 2 == k || 6 == k || 7 == k || 8 == k || 11 == k || 12 == k ? b('<section class="u-arrow-bottom"><img src="' + CLIENT_CDN + 'view/images/btn01_arrow.png" /></section>').appendTo("#page" + h) : (3 == k || 4 == k || 5 == k || 9 == k || 10 == k) && b('<section class="u-arrow-right"><img src="' + CLIENT_CDN + 'view/images/btn01_arrow_right.png" /></section>').appendTo("#page" + h)),
            1 == h && (b(".loading").hide(),
            b(".main-page").eq(0).addClass("z-current")),
            c[h - 1].properties && !b.isEmptyObject(c[h - 1].properties) ? c[h - 1].properties.image || c[h - 1].properties.scratch ? q.scratch ? addScratchEffect(c, h) : !
            function(a) {
                b.getScript(CLIENT_CDN + "view/js/scratch_effect.js", function(b, d, e) {
                    q.scratch = !0,
            ...
            f || (f = !0,
            b.getScript(CLIENT_CDN + "view/js/lock_effect.js", function(a, d, f) {
                test(g, c, e, b(".m-img").width(), b(".m-img").height())
            }))) : c[h - 1].properties.fallingObject ? q.fallingObject ? fallingObject(c, h) : !
            function(a) {
                b.getScript(CLIENT_CDN + "view/js/falling_object.js", function(b, d, e) {
                    q.fallingObject = !0,
                    fallingObject(c, a),
                    1 == a && playVideo(g)
                })
            ...
            }(h) : renderPage(eqShow, h, c) : (renderPage(eqShow, h, c),
            1 == h && playVideo(g)),
            h == c.length) {
                eqxiu.app(b(".nr"), d.obj.pageMode, c, d);
                if (p || b("img").on("dragstart", function(a) {
                    a.preventDefault()
                }),
                !l) {
                    var i = PREFIX_URL + "index.php?c=scene&a=addpv&id=" + d.obj.id;
                    m && (i += "?1=1",
                    i += /\?.*/.test(m) ? "&" + m.substring(1) : /\&.*/.test(m) ? m : "&" + m),
                    i += (/\?/.test(i) ? "&" : "?") + "ad=" + n,
                    b.ajax({
                        type: "GET",
                        url: i,
    ...
    q = [], 
    r = null ;
    a.appendLastPage = function(a, b, h, o, p, q) {
       if (a.obj.property.hideEqAd)
                ...
                a.obj.property.isAdvancedUser ? a.obj.property && a.obj.property.bottomLabel && a.obj.property.bottomLabel.id ? f(a, b) : e(a, b) : d(a, b)
            }
    }
    ,
    p && b(".nr").css({
...
function(window, $) {
    ...
    function getRequestUrl() {
        var a;
        return preview ? (a = isNewPreviewLocation ? PREFIX_URL + "?t=preview&id=" + sceneId + "&preview=preview" + ".data" : PREFIX_URL + "?t=preview&id=" + sceneId + "&preview=preview",
        branchid && (a += (/\?/.test(a) ? "&" : "?") + "user=" + branchid)) : a = mobileview ? PREFIX_URL + "?t=preview&id=" + sceneId : window.scene && window.scene.id ? window.isCheck ? PREFIX_SERVER_HOST + "m/eqs/view/page/" + window.scene.id : PREFIX_S1_URL + "t=preview&id=" + window.scene.id : PREFIX_URL + "?t=preview&id=" + sceneId,
        ...
        if (mobilecheck())
            ...
            with (window._bd_share_config = {
                common: {
                    ...
                    bdUrl: PREFIX_URL + "?t=preview&id=" + sceneId,
                    bdStyle: "0",
                    bdSize: "32"
                },
                share: {}
    ...
    !mobilecheck()) {
        var getBg = function() {
            $.ajax({
                ...
                a ? $("body").css("backgroundImage", "url(" + a + ")") : $("body").css("backgroundImage", "url(/senceCreate/view/images/previewbg_spring.jpg)")
            }, function() {
        ...
        addElmentsForPc = function(a) {
            ...
            c.rel = "stylesheet",
            b.appendChild(c),
            window != window.top ? $("body").css("background-image", "none") : (getBg(),
            $.getScript(CLIENT_CDN + "common/js/qrcode.js", function() {
                $.getScript(CLIENT_CDN + "common/js/jquery.qrcode.js", function() {
                    $("#con").before('<div id="code"><div>扫一扫，分享给朋友！</div><div style="text-align: center;background:#fff;padding: 10px;" id="codeImg"/><div id="view_share" class="bdsharebuttonbox"><a href="#" class="bds_more" data-cmd="more"></a><a href="#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a><a href="#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a><a href="#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a><a href="#" class="bds_sqq" data-cmd="sqq" title="分享到QQ好友"></a><a href="#" class="bds_douban" data-cmd="douban" title="分享到豆瓣网"></a></div></div>');
                    var b, c = getDomain(PREFIX_HOST);
                    b = window.location.href.indexOf(c) >= 0 ? parseInt(10 * Math.random(), 10) % 2 ? PREFIX_HOST : PREFIX_HOST : "http://" + getDomain(window.location.href),
                    $("#codeImg").qrcode({
                        render: "canvas",
                        width: 200,
                        height: 200,
