...
namespace factory
{
    ...
    public static class DbHelperMySQL
    {
        ...
        public static string connectionString = ConfigurationManager.ConnectionStrings["connstr"].ConnectionString; //"Host=127.0.0.1;UserName=root;Password=123456;Database=bbs;character set=gbk;";
        ...
        /// <returns></returns>
        public static bool Exists(string strSql,   MySqlParameter[] cmdParms)
        {
        ...
        public static int ExecuteSql(string SQLString)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                using (MySqlCommand cmd = new MySqlCommand(SQLString, connection))
                {
                    try
                    {
                        //MySqlCommand c2 = new MySqlCommand("SET names GBK ", connection);
                        connection.Open();
                        //c2.ExecuteNonQuery();
