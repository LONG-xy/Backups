    ...
    <form id="form1" runat="server">
        <div style="text-align: center">
            <table bgcolor="#ffffff" border="0" bordercolor="#215dc6" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td height="453" rowspan="2" width="165" style="background-color:#b9b9b9"><iframe src="Tleft.htm" style="width: 165px; height: 453px" frameborder="0" scrolling="no"></iframe>
                    </td>
                ...
                <tr>
                    <td height="155">
                        <iframe id="center" name="menu" frameborder="0" scrolling="auto" style="width: 596px; height: 422px" src="TExaminationInfo.aspx"></iframe>
                        &nbsp;</td>
                </tr>
                <tr>
