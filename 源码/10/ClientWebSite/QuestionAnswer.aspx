                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td height="20" bgcolor="#EEEEEE">
                        <asp:LinkButton ID="lbtnCloseQuestion" runat="server" CommandName="CloseQuestion" OnClientClick="return confirm('确认关闭问题?');" Font-Size="X-Small" ForeColor="#669900">关闭问题</asp:LinkButton>
                    </td>
                  </tr>
                </table></td>
              </tr>
                ...
                <td height="100" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td height="20" bgcolor="#EEEEEE">
                        ...
                        <asp:LinkButton ID="lbtnBestAnswer" runat="server" CommandName="BestAnswer" OnClientClick="return confirm('确认设为最佳答案?');" Font-Size="X-Small" ForeColor="#669900">设为最佳答案</asp:LinkButton>
                    </td>
                  </tr>
                </table></td>
              </tr>
